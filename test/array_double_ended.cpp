...
{
    e::array_double_ended x{0, 1, 2, 3, 4};
    ...
    SECTION ("Comparing arrays")
    {
        ...
        {
            e::array_double_ended y{0, 1, 2, 3};
        ...
        {
            e::array_double_ended y{0, 1, 2, 3, 4, 5};
        ...
        {
            e::array_double_ended y{0, -1, -2, -3, -4};
        ...
        {
            e::array_double_ended y{5, 6, 7, 8, 9};
    ...
    SECTION ("Checking capacity")
    {
        ...
        REQUIRE (e::limit_of_storage(x0) - e::first(x0) == 14);
        CHECK (x0[0] == -3);
        CHECK (x0[1] == -2);
        CHECK (x0[2] == -1);
        CHECK (x0[3] == 0);
    ...
    {
        auto fn0 = [](int const& i){ return e::array_double_ended<int>{i, -i}; };
