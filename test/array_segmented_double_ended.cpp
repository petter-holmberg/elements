...
{
    e::array_segmented_double_ended x{0, 1, 2, 3, 4};
    ...
    SECTION ("Comparing arrays")
    {
        ...
        {
            e::array_segmented_double_ended y{0, 1, 2, 3};
        ...
        {
            e::array_segmented_double_ended y{0, 1, 2, 3, 4, 5};
        ...
        {
            e::array_segmented_double_ended y{0, -1, -2, -3, -4};
        ...
        {
            e::array_segmented_double_ended y{5, 6, 7, 8, 9};
