...
#include "list_doubly_linked_sentinel.h"

namespace e = elements;

SCENARIO ("Using doubly linked list with sentinel", "[list_doubly_linked_sentinel]")
{
    e::list_doubly_linked_sentinel<int> x{0, 1, 2, 3, 4};
    ...
    SECTION ("Comparing lists")
    {
        ...
        {
            e::list_doubly_linked_sentinel<int> y{0, 1, 2, 3};
        ...
        {
            e::list_doubly_linked_sentinel<int> y{0, 1, 2, 3, 4, 5};
        ...
        {
            e::list_doubly_linked_sentinel<int> y{0, -1, -2, -3, -4};
        ...
        {
            e::list_doubly_linked_sentinel<int> y{5, 6, 7, 8, 9};
    ...
    {
        e::list_doubly_linked_sentinel<int> x0;
    ...
    {
        e::list_doubly_linked_sentinel<int> x0{0, 1, 2};
        e::list_doubly_linked_sentinel<int> x1;
    ...
    {
        auto fn0 = [](int const& i){ return e::list_doubly_linked_sentinel<int>{i, -i}; };
