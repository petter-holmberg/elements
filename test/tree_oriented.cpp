...
SCENARIO ("Using oriented tree", "[tree_oriented]")
{
    e::tree_oriented<int> x;
    ...
    SECTION ("Checking elements")
    {
        ...
        {
            e::tree_oriented<int> y_left{2, y, {}};
        ...
        {
            e::tree_oriented<int> y_right{1, {}, y};
        ...
        {
            e::tree_oriented<int> y_both{3, y, y};
