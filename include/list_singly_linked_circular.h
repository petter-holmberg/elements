...
template <typename T>
struct functor_t<list_singly_linked_circular<T>>
{
    using constructor_type = list_singly_linked_circular<T>;

    template <Operation<T> Op>
    static constexpr auto
    fmap(list_singly_linked_circular<T>& x, Op op) -> list_singly_linked_circular<T>&
    {
        using elements::copy;
    ...
    static constexpr auto
    fmap(list_singly_linked_circular<T>&& x, F fun) -> list_singly_linked_circular<Return_type<F, T>>
    {
        using elements::map;
        list_singly_linked_circular<Return_type<F, T>> y;
