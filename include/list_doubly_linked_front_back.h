...
template <typename T>
struct functor_t<list_doubly_linked_front_back<T>>
{
    using constructor_type = list_doubly_linked_front_back<T>;

    template <Operation<T> Op>
    static constexpr auto
    fmap(list_doubly_linked_front_back<T>& x, Op op) -> list_doubly_linked_front_back<T>&
    {
        using elements::copy;
    ...
    static constexpr auto
    fmap(list_doubly_linked_front_back<T>&& x, F fun) -> list_doubly_linked_front_back<Return_type<F, T>>
    {
        using elements::map;
        list_doubly_linked_front_back<Return_type<F, T>> y;
